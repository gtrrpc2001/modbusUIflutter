...
class bzone extends StatefulWidget{

  @override
  _bzone createState() => _bzone();

}

class _bzone extends State<bzone>{
  ...
  Widget SetStack(){
    return Stack(
      ...
      children: pagesBody.stackChildren(uiList,_positionXYList,1)
    );
  }
